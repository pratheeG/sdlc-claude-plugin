...
echo "    sdlc-alex     Alex     · brainstorm (greenfield & brownfield)"
...
echo ""
echo "  Starting from scratch (no requirements doc yet):"
echo "    /sdlc brainstorm \"rough idea or problem statement\""
echo ""
echo "  Starting from an existing requirements doc:"
...
echo "    /sdlc status"
echo ""
echo "  Full auto-run (ingest → plan → sprint):"
